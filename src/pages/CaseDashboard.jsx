...
function FilterBar({ filters, setFilter, resetFilters, onNewCase, investigators }) {
  return (
    <div style={{
      ...
      {/* Reset */}
      <button className="btn-ghost" onClick={resetFilters} id="reset-filters">
        Reset
      </button>
    ...
    >
      ...
      <div style={{ ...COL_STYLES.title }}>
        ...
        {caseData.investigator && (
          <span style={{ fontSize: 10.5, color: '#5A5A65', marginLeft: 8 }}>
            {caseData.investigator}
          </span>
        )}
      </div>
    ...
    >
      ...
      <div style={{
        ...
        <span className="data-label">
          Last sync: {fmtTimestamp(new Date().toISOString())}
        </span>
      </div>
    </div>
  );
